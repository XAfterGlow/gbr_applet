...
Page({
    ...
    countDown: function(t, a, e) {
        var o = parseInt(Date.now() / 1e3), s = parseInt((o < t ? t : a) - o), i = Math.floor(s / 86400), d = Math.floor((s - 24 * i * 60 * 60) / 3600), n = Math.floor((s - 24 * i * 60 * 60 - 3600 * d) / 60), r = Math.floor(s - 24 * i * 60 * 60 - 3600 * d - 60 * n);
    ...
    tuxedobuy: function(e) {
        ...
        0 == o.data.data.goods.more_spec ? 0 < o.data.data.goods.stock ? a.get("groups/order/create_order", {
            id: s,
            ...
            optionarr: [],
            selectSpecsarr: []
        }), 0 < o.data.data.goods.stock ? wx.navigateTo({
    ...
    specsTap: function(t) {
        ...
        1 == e ? (r.push(d), u.push(i)) : -1 < u.indexOf(i) ? r.splice(n, 1, d) : (r.push(d), 
    ...
    buy: function(t) {
        ...
        e.data.optiondata ? 0 < s.stock ? wx.navigateTo({
