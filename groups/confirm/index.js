...
Page({
    ...
    onLoad: function(e) {
        ...
        this.setData({
            ...
            }), 0 < a.data.fields.length && i.setData({
                diyform: {
    ...
    onConfirm: function(a) {
        ...
        e[t[0]].city[t[1]].area && 0 < e[t[0]].city[t[1]].area.length ? (d.area = e[t[0]].city[t[1]].area[t[2]].name, 
    ...
    clearform: function() {
        var i = this.data.diyform, d = {};
        e.each(i, function(a, t) {
            e.each(t, function(a, t) {
                5 == t.data_type && (i.f_data[t.diy_type].count = 0, i.f_data[t.diy_type].images = [], 
                d[t.diy_type] = i.f_data[t.diy_type]);
            });
        }), i.f_data = d, this.setData({
            diyform: i
        });
    },
    submit: function() {
