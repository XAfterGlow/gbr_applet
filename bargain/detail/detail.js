...
Page({
    ...
    countDown: function(t, i, a) {
        var e = parseInt(Date.now() / 1e3), r = parseInt((e < t ? t : i) - e), s = Math.floor(r / 86400), n = Math.floor((r - 24 * s * 60 * 60) / 3600), o = Math.floor((r - 24 * s * 60 * 60 - 3600 * n) / 60), l = [ s, n, o, Math.floor(r - 24 * s * 60 * 60 - 3600 * n - 60 * o) ];
        this.setData({
            time: l
        });
        var h = "";
        e < t ? (h = "未开始", this.setData({
            istime: 0
        })) : t <= e && e < i ? (h = "剩余时间", this.setData({
            istime: 1
