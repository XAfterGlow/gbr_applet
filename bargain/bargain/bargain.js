...
Page({
    ...
    cutPrice: function() {
        ...
        a.checkAuth(function() {
            var i = "/pages/auth/index", r = n, a = r.data.bargainid, e = r.data.mid;
    ...
    countDown: function(a, t, i) {
        var r = parseInt(Date.now() / 1e3), e = parseInt((r < a ? a : t) - r), n = Math.floor(e / 86400), s = Math.floor((e - 24 * n * 60 * 60) / 3600), o = Math.floor((e - 24 * n * 60 * 60 - 3600 * s) / 60), g = [ n, s, o, Math.floor(e - 24 * n * 60 * 60 - 3600 * s - 60 * o) ];
        this.setData({
            time: g
        });
        var d = "";
        r < a ? (d = "未开始", this.setData({
            istime: 0
        })) : a <= r && r < t ? (d = "剩余时间", this.setData({
            istime: 1
