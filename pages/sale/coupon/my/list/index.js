...
t.requirejs("foxui"), Page({
    ...
    initCategory: function() {
        var a = this;
        e.get("goods/get_category", {}, function(t) {
            a.setData({
                allcategory: t.allcategory,
                category_parent: t.allcategory.parent,
                category_child: [],
                category_third: [],
                catlevel: t.catlevel,
                opencategory: t.opencategory,
                show: !0
            });
        });
    },
    getList: function() {
        ...
        a.setData({
            loading: !0
        }), this.data.canload = !1, a.data.params.page = a.data.page, e.get("sale/coupon/my/get_list", a.data.params, function(t) {
            var e = {
                loading: !1,
                count: t.total,
                show: !0
