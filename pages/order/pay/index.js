...
Page({
    ...
    get_list: function() {
        var s = this;
        e.get("order/pay", s.data.options, function(t) {
            50018 != t.error ? (!t.wechat.success && "0.00" != t.order.price && t.wechat.payinfo && e.alert(t.wechat.payinfo.message + "\n不能使用微信支付!"), 
            s.setData({
                list: t,
                show: !0
            })) : wx.navigateTo({
                url: "/pages/order/details/index?id=" + s.data.options.id
            });
        });
    },
    pay: function(t) {
