...
e.requirejs("jquery"), Page({
    ...
    get_list: function() {
        var r = this;
        void 0 === r.data.options.singlerefund ? s.get("order/express_number", r.data.options, function(e) {
            0 == e.error ? (e.show = !0, r.setData(e)) : s.toast(e.message, "loading");
        }) : s.get("order/single_express_number", r.data.options, function(e) {
            0 == e.error ? (e.show = !0, r.setData(e)) : s.toast(e.message, "loading");
        });
    },
