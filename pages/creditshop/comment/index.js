...
Page({
    ...
    get_list: function() {
        var a = this;
        e.get("creditshop/comment", a.data.options, function(t) {
            0 == t.error ? (t.show = !0, a.setData(t), a.setData({
                log: t.log,
                is_openmerch: t.is_openmerch,
                shop: t.shop,
                credittext: t.sysset.texts.credit
            })) : (e.toast(t.message, "loading"), wx.navigateBack());
        }, !0);
    },
    select: function(t) {
