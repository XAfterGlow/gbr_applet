...
Page({
    ...
    getData: function() {
        var e = this;
        a.get("wemecms/merch/apply", {}, function(t) {
            1 == t.canapply ? (t.show = !0, e.setData(t)) : a.alert(t.message);
        }, !1, !0);
    },
    ...
    submit: function(t) {
        ...
        if (s.canapply && !s.isSubmit) {
            ...
            a.confirm("确认要提交申请吗？", function() {
                e.setData({
                    isSubmit: !0
                }), a.post("wemecms/merch/apply", s.reg, function(t) {
    ...
    confirmjoin: function(t) {
        ...
        s.isSubmit || (e.setData({
            isSubmit: !0
        }), a.post("wemecms/merch/confirmjoin", s.reg, function(t) {
            if (1 != t.status) return i.toast(e, t.result.message), void e.setData({
                isSubmit: !1
            });
