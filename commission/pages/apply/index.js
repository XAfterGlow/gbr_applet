...
Page({
    ...
    getData: function() {
        var n = this;
        t.get("commission/apply", {}, function(a) {
            e.isEmptyObject(a.type_array) ? (t.alert(a.message || "没有提现方式!"), setTimeout(function() {
                70001 == a.error ? wx.redirectTo({
                    url: "/pages/member/info/index"
                }) : wx.navigateBack();
            }, 2e3)) : (a.show = !0, e.isArray(a.last_data) && (a.last_data = {}), a.last_data && (a.last_data.alipay1 = a.last_data.alipay, 
            a.last_data.bankcard1 = a.last_data.bankcard), a.bankIndex = a.bankIndex || 0, n.setData(a));
        }, !1, !0);
    },
    ...
    submit: function(a) {
        ...
        if (s.cansettle && !s.isSubmit) {
            ...
            e = s.applytype < 2 ? "确认要" + r + "？" : "确认要" + r, 0 < s.set_array.charge && (e += " 扣除手续费 " + s.deductionmoney + " 元,实际到账金额 " + s.realmoney + " 元"), 
